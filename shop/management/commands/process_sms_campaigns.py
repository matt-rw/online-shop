"""
Management command to process scheduled SMS campaigns.
...
from shop.models import SMSCampaign
...
class Command(BaseCommand):
    help = 'Process scheduled SMS campaigns that are ready to be sent'
    ...
    def handle(self, *args, **options):
        ...
        for campaign in campaigns:
            ...
            try:
                ...
                self.stdout.write(
                    self.style.ERROR(f'Campaign {campaign.id} error: {str(e)}')
                )
