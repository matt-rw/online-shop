...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            type=int,
            default=150,
            help='Number of email subscribers to create'
        )
        parser.add_argument(
            '--sms',
            type=int,
            default=100,
            help='Number of SMS subscribers to create'
        )
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f'Creating {email_count} email subscribers and {sms_count} SMS subscribers...')
        ...
        for i in range(sms_count):
            try:
                ...
                SMSSubscription.objects.filter(id=subscriber.id).update(
                    subscribed_at=subscribed_at
                )
