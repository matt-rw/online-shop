...
urlpatterns = [
    ...
    path("admin/quick-links/", admin_views.quick_links_settings, name="admin_quick_links"),
    path("admin/bug-reports/", admin_views.bug_reports_dashboard, name="admin_bug_reports"),
